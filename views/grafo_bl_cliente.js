...
document.getElementById("searchForm").addEventListener("submit", async function(event) {
   ...
   if (result.resultado) {
       document.getElementById("caminho").innerText = result.resultado.sf + " Custo total: " + result.resultado.vf + " Solucão inicial: " + result.resultado.si + " Custo inicial: " + result.resultado.vi;
    ;
